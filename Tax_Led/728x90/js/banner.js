...
function initCSS() {
    ...
    TweenLite.set("#messaging-frame-01b", {autoAlpha:0});
...
function startAnimation() {
    ...
    tl.from("#messaging-frame-00", 2, {alpha: 0, y:-10, ease: Power1.easeInOut}, "1");
    ...
    tl.to("#red-gradient", 2, {rotation:35, autoAlpha:1, x:-314, y:-300, scale:1, ease: Power1.easeOut}, "0"); //-118
    ...
    tl.to('#solid-red-base2', 4, {x:320, y:500, ease:Power1.easeOut}, 'imageFrame+=.3')
    ...
    tl.from(".terms", 1.2, {alpha: 0, ease: Power1.easeOut}, "frame02+=.3");
